...
impl FactoryType {
    ...
    pub fn display_name(self) -> &'static str {
        match self {
            ...
            Self::EntityDummy => "EntityDummy",
            Self::Actor => "Actor",
            Self::HumanNpc => "HumanNPC",
            Self::Player => "Player",
            Self::Car => "Car",
            Self::CrashObject => "CrashObject",
            Self::TrafficCar => "TrafficCar",
            Self::TrafficHuman => "TrafficHuman",
            Self::TrafficTrain => "TrafficTrain",
            Self::ActionPoint => "ActionPoint",
            Self::ActionPointRoadBlock => "ActionPointRoadBlock",
            Self::ActionPointBase => "ActionPointBase",
            Self::ActionPointCrossing => "ActionPointCrossing",
            Self::ActionPointSideWalk => "ActionPointSideWalk",
            Self::ActionPointScript => "ActionPointScript",
            Self::ActionPointSearch => "ActionPointSearch",
            Self::DamageZone => "DamageZone",
            Self::TelephoneReg => "TelephoneReg",
            Self::Item => "Item",
            ...
            Self::StaticWeapon => "StaticWeapon",
            Self::StaticWeaponWrap => "StaticWeaponWrap",
            Self::FireTarget => "FireTarget",
            Self::FrameWrapper => "FrameWrapper",
            Self::ShopMenuScript => "ShopMenuScript",
            Self::StaticParticle => "StaticParticle",
            Self::LightEntity => "LightEntity",
            Self::Pinup => "Pinup",
            Self::Cutscene => "Cutscene",
            Self::Jukebox => "Jukebox",
            Self::Telephone => "Telephone",
            Self::ScriptEntity => "ScriptEntity",
            Self::Blocker => "Blocker",
            Self::ActorDetector => "ActorDetector",
            Self::Boat => "Boat",
            Self::CutsceneEnt => "CutsceneEnt",
            Self::DummyDoor => "DummyDoor",
            Self::StaticEntity => "StaticEntity",
            Self::FramesController => "FramesController",
            Self::CleanEntity => "CleanEntity",
            Self::CarVehicle => "CarVehicle",
            Self::TranslocatedCar => "TranslocatedCar",
            Self::CleanEntityAlt => "CleanEntityAlt",
            Self::PhysicsScene => "PhysicsScene",
            Self::Train => "Train",
            Self::Radio => "Radio",
            Self::Garage => "Garage",
            Self::SpikeStrip => "SpikeStrip",
        }
    }
